...
#ifndef __usb_command_t_hpp__
#define __usb_command_t_hpp__
...
int usb_command_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int usb_command_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int usb_command_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t usb_command_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* usb_command_t::getTypeName()
{
    return "usb_command_t";
}

int usb_command_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int usb_command_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
